...
public T value;
  ...
  public abstract Tree<T> degenarate(Tree<T> u);
  public abstract int countAtLevel(int x);
  public abstract boolean issubtree(Tree<T> a) ;
...
@Override
public Tree<T> degenarate(Tree<T> u) {
	return this;
}
...
@Override
public boolean issubtree(Tree<T> a) {
...
@Override
public Tree<T> degenarate(Tree<T> u) {
	return !u.isEmpty() ?  new Cons<T>(value,left.degenarate(left),new Empty<T>()) : new Cons<T>(value,new Empty<T>(),right.degenarate(left)) ;
	}
